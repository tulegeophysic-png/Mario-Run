...
function loadLevel(index) {
  ...
  const springMushrooms = springs.map((spring, springIndex) => ({ x: spring.x, y: Math.max(96, spring.y - springBounceHeight - 8), taken: false, w: 32, h: 24, type: springIndex === 1 ? 'green' : 'red', springSource: spring }));
